...
// animação e ativador de animação
  ...
  return (
    <div className='box-menu'>
      ...
      <div className='Logo'>
        <Link to="/jogo1">
          <div className='anim'>
            <LottieAnimation lotti={search} height={125} width={160} />
          </div>
          <div>
            <h1>Find Stuff</h1>
            <p>Click to start</p>
